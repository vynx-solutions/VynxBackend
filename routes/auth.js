...
app.post("/auth/v1/oauth/token", async (req, res) => {
    res.json({
        access_token: "vynxtokenoniichan",
        token_type: "bearer",
        ...
        organization_id: "vynxtokenoniichan",
        product_id: "prod-fn",
        sandbox_id: "fn",
        deployment_id: "vynxdeploymentidokasanbaka",
        expires_in: 3599
    });
})
...
app.post("/epic/oauth/v2/token", async (req, res) => {
    ...
    res.json({
        ...
        token_type: "bearer",
        access_token: "vynxtokenoniichan",
        refresh_token: "vynxrefreshtokenotosan",
        id_token: "vynxidtokenbaka",
        expires_in: 7200,
        expires_at: "9999-12-31T23:59:59.999Z",
        ...
        account_id: req.user.accountId,
        client_id: clientId,
        application_id: "vynxsacpplicationidaishteimasu",
