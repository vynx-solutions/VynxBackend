...
app.post("/fortnite/api/game/v2/chat/*/*/*/pc", (req, res) => {
    ...
    let resp = config.chat.EnableGlobalChat ? { "GlobalChatRooms": [{ "roomName": "vynxbackendglobal" }] } : {};
...
app.get("/launcher/api/public/assets/*", async (req, res) => {
    res.json({
        ...
        "labelName": "VynxBackend",
        "buildVersion": "++Fortnite+Release-20.00-CL-19458861-Windows",
        "catalogItemId": "5cb97847cee34581afdbc445400e2f77",
        "expires": "9999-12-31T23:59:59.999Z",
        "items": {
            "MANIFEST": {
                "signature": "VynxBackend",
                "distribution": "https://vynxbackend.ol.epicgames.com/",
                "path": "Builds/Fortnite/Content/CloudDir/VynxBackend.manifest",
...
app.get("/Builds/Fortnite/Content/CloudDir/*.manifest", async (req, res) => {
    ...
    const manifest = fs.readFileSync(path.join(__dirname, "..", "responses", "CloudDir", "VynxBackend.manifest"));
...
app.get("/Builds/Fortnite/Content/CloudDir/*.chunk", async (req, res) => {
    ...
    const chunk = fs.readFileSync(path.join(__dirname, "..", "responses", "CloudDir", "VynxBackend.chunk"));
